...
-- Dependencies: 3
-- Name: SCHEMA public; Type: COMMENT; Schema: -; Owner: workshops_user
--
...
-- Name: notion_model; Type: TABLE; Schema: public; Owner: workshops_user
--
...
-- Name: workshop_model; Type: TABLE; Schema: public; Owner: workshops_user
--
...
-- Name: workshop_model_id_seq; Type: SEQUENCE; Schema: public; Owner: workshops_user
--
...
-- Dependencies: 210
-- Name: workshop_model_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: workshops_user
--
...
-- Name: workshop_model_notions; Type: TABLE; Schema: public; Owner: workshops_user
--
...
-- Name: workshop_model id; Type: DEFAULT; Schema: public; Owner: workshops_user
--
...
-- Dependencies: 209
-- Data for Name: notion_model; Type: TABLE DATA; Schema: public; Owner: workshops_user
--
...
-- Dependencies: 211
-- Data for Name: workshop_model; Type: TABLE DATA; Schema: public; Owner: workshops_user
--
...
-- Dependencies: 212
-- Data for Name: workshop_model_notions; Type: TABLE DATA; Schema: public; Owner: workshops_user
--
...
-- Dependencies: 210
-- Name: workshop_model_id_seq; Type: SEQUENCE SET; Schema: public; Owner: workshops_user
--
...
-- Name: notion_model notion_model_pkey; Type: CONSTRAINT; Schema: public; Owner: workshops_user
--
...
-- Name: workshop_model workshop_model_pkey; Type: CONSTRAINT; Schema: public; Owner: workshops_user
--
...
-- Name: workshop_model_notions fk1gva2ft1rtngr48163q5tie08; Type: FK CONSTRAINT; Schema: public; Owner: workshops_user
--
...
-- Name: workshop_model_notions fki6yxgb1j2hcgytt03w777cift; Type: FK CONSTRAINT; Schema: public; Owner: workshops_user
--
